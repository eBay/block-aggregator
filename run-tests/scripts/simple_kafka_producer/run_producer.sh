...
echo "to run launch_serializer_based_producer:  ${brokers} ${topic} ${number_of_messages} ${number_of_tables}  --create ${zoo_keepers} ${number_of_partitions} "

../../deployed/launch_serializer_based_producer  ${brokers} ${topic} ${number_of_messages} ${number_of_tables} --create ${zoo_keepers} ${number_of_partitions}
