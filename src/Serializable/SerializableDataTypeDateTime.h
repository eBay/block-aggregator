 ...
 */
class SerializableDataTypeDateTime final : public SerializableDataTypeNumberBase<DB::UInt32> {
  public:
    SerializableDataTypeDateTime(const std::string& time_zone_name = "");

    const char* getFamilyName() const override { return "DateTime"; }
    std::string doGetName() const override;
    DB::TypeIndex getTypeId() const override { return DB::TypeIndex::DateTime; }
